...
dir.create("Cleaning_6_Cleaning_Maps")
...
write.csv(file = "Raw_Data/Taxa/European_Bee_Species_MCP_Area_Percent.csv", x =  data.frame(Scientific_Name), row.names = FALSE)

Bee_Percent<-read.csv("Raw_Data/Taxa/European_Bee_Species_MCP_Area_Percent.csv")  ### Load manual evaluation of the area plots 
